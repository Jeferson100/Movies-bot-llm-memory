...
def test_extracao_textos_links_crawl4ai():
    with patch(
        "extracao.extracao_textos_links_crawl4ai", return_value="extracao_crawl4ai"
    ):
...
def test_extracao_textos_links_html2text():
    with patch(
        "extracao.extracao_textos_links_html2text", return_value="extracao_html2text"
    ):
        url = "https://www.crawl4ai.com/"
...
def test_extracao_textos_clean_crawl4ai():
    with patch(
        "extracao.extracao_textos_links_crawl4ai",
        return_value="extracao_clean_crawl4ai",
    ):
        url = "https://www.crawl4ai.com/"
        extracao = LinksExtractor()
...
def test_extracao_textos_clean_html2text():
    with patch(
        "extracao.extracao_textos_links_html2text",
        return_value="extracao_clean_html2text",
    ):
        url = "https://www.crawl4ai.com/"
        extracao = LinksExtractorHtml2Text()
